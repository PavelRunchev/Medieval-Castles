...
<section id="post-france">
    <div class="france-castles">
        ...
        <article class="bamburgh">
            <img src="/assets/France Castles/montSaintMichel2.jpg" alt="photo">
        ...
        <article class="carcassonne">
            <img src="/assets/France Castles/Carcassonne.jpg" alt="photo">
        ...
        <article class="chenonceau">
            <img src="/assets/France Castles/Chenonceau.jpg" alt="photo">
