...
<section id="post-germany">
    <div class="germany-castles">
        ...
        <article class="neuschwanstein">
            <img src="{{ site.baseurl }}/assets/2.gif" data-src="{{ site.baseurl }}/assets/Germany Castles/Neuschwanstein_Castle.jpg" alt="photo">
        ...
        <article class="hohenzollern">
            <img src="{{ site.baseurl }}/assets/2.gif" data-src="{{ site.baseurl }}/assets/Germany Castles/hohenzollern_castle.jpg" alt="photo">
        ...
        <article class="hohenschwangau">
            <img src="{{ site.baseurl }}/assets/2.gif" data-src="{{ site.baseurl }}/assets/Germany Castles/Hohenschwangau-Castle.jpg" alt="photo">
        ...
        <article class="schwerin">
            <img src="{{ site.baseurl }}/assets/2.gif" data-src="{{ site.baseurl }}/assets/Germany Castles/schwerin-palace-germany-29182-1920x1200.jpg" alt="photo">
        ...
        <article class="lichtenstein">
            <img src="{{ site.baseurl }}/assets/2.gif" data-src="{{ site.baseurl }}/assets/Germany Castles/castle-lichtenstein-germany-shutterstock.jpg" alt="photo">
